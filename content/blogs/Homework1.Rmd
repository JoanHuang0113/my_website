...
clean_electionresults <- election2020_results %>% 
  ...
  mutate(trump_percentage=candidatevotes/totalvotes*100) %>% 
...
This graph depicts the percentage of each county that is vaccinated, based on the percent that voted for Trump in the 2020 presidential elections.
